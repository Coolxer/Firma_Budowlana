...
namespace firma_budowlana.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            ViewBag.autor_zgloszenia = new SelectList(db.klienci, "id", "nazwa_firmy");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id,autor_zgloszenia,opis,data_utworzenia")] zgloszenia zgloszenia)
        {
            ...
            ViewBag.autor_zgloszenia = new SelectList(db.klienci, "id", "nazwa_firmy", zgloszenia.autor_zgloszenia);
