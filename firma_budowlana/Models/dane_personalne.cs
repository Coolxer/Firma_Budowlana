...
namespace firma_budowlana.Models
{
    ...
    public partial class dane_personalne
    {
        ...
        [Required]
        [RegularExpression("^[Aa•πBbCc∆ÊDdEe ÍFfGgHhIiJjKkLl£≥MmNn—ÒOo”ÛPpRrSsåúTtUuWwYyZzèüØø]{3,50}", ErrorMessage = "Nazwisko musi zawieraÊ same litery. Miniumum 3, maksimum 50")]
        public string nazwisko { get; set; }

        [Required]
        [RegularExpression("^[0-9]{11}$", ErrorMessage = "Pesel musi mieÊ dok≥adnie 11 cyfr")]
